"""
Django settings for CAAcodingPalace project.
...
SECRET_KEY = 'django-insecure-+n_pt31)xzx=-#@)n2**2^cn(eoa3r5@9_$*i69z_!&u4ufj=6'
...
WSGI_APPLICATION = 'CAAcodingPalace.wsgi.application'
